  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Categories by Depth</CardTitle>
            <CardDescription>Distribution across hierarchy levels</CardDescription>
          </CardHeader>
          <CardContent>
            {depthData.length > 0 ? (
              <ResponsiveContainer width="100%" height={250}>
      ...
      {stats && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Full dashboard stats payload</CardDescription>
          </CardHeader>
          <CardContent>
